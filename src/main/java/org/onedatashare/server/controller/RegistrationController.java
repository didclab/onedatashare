...
public class RegistrationController {
    ...
    public Object registerUser(@RequestBody RegistrationControllerRequest request) {
        return userService.register(request.getEmail(), request.getFirstName(), request.getLastName(),
                request.getPassword(), request.getOrganization(), request.getCaptchaVerificationValue());
    }
...
//    @RequestMapping(value="/confirm-account", method= {RequestMethod.GET, RequestMethod.POST})
    @RequestMapping(value="/confirm-account", method= {RequestMethod.GET, RequestMethod.POST})
    public Mono<String> verifyEmailUsingCode(@RequestBody RegistrationControllerRequest request, @RequestParam("token")String confirmationToken) {
        return userService.verifyCode(request.getEmail(), confirmationToken);
    }
    @Data
