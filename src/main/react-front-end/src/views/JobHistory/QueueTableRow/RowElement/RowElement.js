  ...
  render() {
    ...
    return (
      <React.Fragment>
              ...
              >
                <Table>
                  ...
                  {resp.batchSteps.map((file) => {
                    ...
                    return (
                      <TableRow>
                        <TableCell>{file.step_name}</TableCell>
                        <TableCell>
                          {this.findTimeDiff(file.startTime, file.endTime)}
                        </TableCell>
                        <TableCell>{JSON.stringify(file.exitCode)}</TableCell>
                        <TableCell>{JSON.stringify(file.readCount)}</TableCell>
                        <TableCell>{JSON.stringify(file.writeCount)}</TableCell>
                      </TableRow>
                    );
                  })}
                </Table>
        ...
        <TableRow
          className={this.state.expanded ? "Row" : "Row expanded"}
          onClick={() => {
            this.handleToggle();
          }}
        >
