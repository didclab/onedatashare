...
export default class UserAccountComponent extends Component {
      ...
      <React.Fragment>
        ...
        <List>
          ...
          <ListItem alignItems="flex-start">
            <ListItemText
              primary="First Name"
              secondary={<UserAccountField textDisplayed={this.state.fName} />}
            />
          </ListItem>
          <Divider variant="middle" />
          <ListItem alignItems="flex-start">
            <ListItemText
              primary="Last Name"
              secondary={<UserAccountField textDisplayed={this.state.lName} />}
            />
          </ListItem>
          <Divider variant="middle" />
          <ListItem alignItems="flex-start">
                ...
                <UserAccountField
                  textDisplayed={
                    <React.Fragment>
                      ...
                      />
                      <Typography id={"copyStatus"} style={{ display: "none" }}>
                        Copied!
                      </Typography>
                      {/*{this.getToken()}*/}
                    </React.Fragment>
    ...
    return (
      <React.Fragment>
              ...
              <React.Fragment>
                <InputAdornment position="end">
                  <IconButton
                    ...
                    onClick={() => {
                      this.togglePwdVisibility("old");
                    }}
                  >
                    {this.state.isOldPwdVisible ? (
              ...
              <React.Fragment>
                <InputAdornment position="end">
                  <IconButton
                    aria-label="toggle password visibility"
                    onClick={() => {
                      this.togglePwdVisibility("new");
                    }}
                  >
                    {this.state.isNewPwdVisible ? (
                      <VisibilityOutlinedIcon />
                    ) : (
                      <VisibilityOffOutlinedIcon />
                    )}
              ...
              <React.Fragment>
                <InputAdornment position="end">
                  <IconButton
                    aria-label="toggle password visibility"
                    onClick={() => {
                      this.togglePwdVisibility("confirm");
                    }}
                  >
                    {this.state.isConfirmPwdVisible ? (
                      <VisibilityOutlinedIcon />
                    ) : (
                      <VisibilityOffOutlinedIcon />
                    )}
        ...
        <PasswordRequirementsComponent
          showList={
            !this.state.isValidNewPassword || !this.state.isValidConfirmPassword
          }
          errorMsg={this.state.errorMsg}
        />
        <CardActions style={{ marginBottom: "0px" }}>
          <Button size="small" color="primary" onClick={this.toggleModalClose}>
            Cancel
          </Button>
          <Button
            size="small"
  ...
  togglePwdVisibility = (field) => {
    const { isOldPwdVisible, isNewPwdVisible, isConfirmPwdVisible } =
      this.state;
    switch (field) {
      case "old":
      ...
      >
        ...
        >
          ...
          <Dialog open={modalIsOpen} onClose={this.toggleModalClose}>
            ...
            <DialogContent>{this.changePasswordForm()}</DialogContent>
          </Dialog>
        </div>
      </div>
    );
