...
export default class FileNodeCompact extends Component {
  ...
  shouldComponentUpdate(nextProps, nextState) {
    if (
      this.arraysEqual(nextProps.columns, this.props.columns) &&
  ...
  onTouchEnd = (event) => {
    ...
    if (
      ...
      this.state.dragging ||
      (this.deltaX && Math.abs(this.deltaX) > 5) ||
      (this.deltaY && Math.abs(this.deltaY) > 5)
    ) {
      return;
    }
    if (!this.timestamp) {
            ...
            >
              ...
              {columns[0] && (
                ...
                >
                  ...
                  <p
                    id={"filename" + endpoint.side + fileId}
                    style={{ ...pstyle, width: posit0 - 40, minWidth: "50" }}
                  >
                    {" "}
                    {name}{" "}
                  </p>
              ...
              {columns[1] && (
                ...
                >
                  <p
                    id={"date" + endpoint.side + fileId}
                    style={{ ...pstyle, width: posit1 }}
                  >
                    {time === 0
                      ? "Not Available"
              ...
              {columns[2] && (
                ...
                >
                  <p
                    id={"perm" + endpoint.side + fileId}
                    style={{ ...pstyle, width: posit2 }}
                  >
                    {" "}
                    {perm ? perm : "N/A"}{" "}
                  </p>
              ...
              {columns[3] && (
                ...
                >
                  <p
                    id={"size" + endpoint.side + fileId}
                    style={{ ...pstyle, width: posit3 }}
                  >
                    {" "}
                    {size === 0 ? "N/A" : this.humanFileSize(size)}{" "}
                  </p>
                </td>
              )}
            </FileDiv>
