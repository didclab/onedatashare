...
export default class GetStartedComponent extends Component {
  constructor() {
    ...
    this.data = [
      ...
      {
        title:
          "Intiate a transfer by dragging a file/folder from one endpoint to another",
        imgPath: gs5,
        imgStyle: { ...imgStyle },
      },
      {
  ...
  render() {
    ...
    this.data.forEach((item) => {
      carouselItems.push(
        <Carousel.Item style={carouselItemStyle}>
          <div style={{ fontSize: "2em", color: "white" }}>{item.title}</div>
          <div>
    ...
    return (
      <div
        className="adjustTop adjustContent content"
