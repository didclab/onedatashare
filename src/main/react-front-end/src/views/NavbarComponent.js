          ...
          <Toolbar style={{ marginLeft: "1%" }}>
              ...
              <Hidden smDown>
                {this.state.login && (
                  <Box display="flex" width={"50%"}>
                    <Link
                      to={siteURLS.transferPageUrl}
                      href={siteURLS.transferPageUrl}
                      id="NavTransfer"
                    ...
                    <Link
                      to={siteURLS.queuePageUrl}
                      href={siteURLS.queuePageUrl}
                      id="NavQueue"
                      className={"navbarButton"}
                    >
                      Queue
                    ...
                    {this.state.admin === true && <AdminDropdown />}
                  </Box>
                )}
              </Hidden>
            </Grid>
            <Hidden smDown>
              <Box className={"rightNav"}>
                {this.state.login && (
                  <Link
                    to={siteURLS.userPageUrl}
                    id="NavEmail"
                    href={siteURLS.userPageUrl}
                    className={"navbarButton"}
                  >
                    {this.state.email}
                  </Link>
                ...
                {!this.state.login && (
                  <Link
                    to={siteURLS.registerPageUrl}
                    id="NavRegister"
                    href={siteURLS.registerPageUrl}
                    className={"navbarButton"}
                  >
                    Register
                  </Link>
                ...
                <Link
                  to={siteURLS.supportPageUrl}
                  href={siteURLS.supportPageUrl}
                  className={"navbarButton"}
                >
                  Support
                </Link>
