    ...
    if (this.state.captchaVerified) {
      ...
      submitIssue(
        ...
        (resp) => {
          ...
          msgDiv.innerHTML =
            "Support ticket created successfully. Ticket number - " + resp;
        ...
        (err) => {
          ...
          msgDiv.innerHTML =
            'There was an error while creating the support ticket. Please try again or email us at <a href="mailto:admin@onedatashare.org">admin@onedatashare.org</a>';
          msgDiv.style.visibility = "visible";
          this.resetCaptcha();
        }
      );
        ...
        <Container maxWidth={"md"} style={{ display: "flex" }}>
          ...
          >
            ...
            >
              ...
              {process.env.REACT_APP_GC_CLIENT_KEY && (
