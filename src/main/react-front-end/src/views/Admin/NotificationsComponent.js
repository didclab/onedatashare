...
const ExtendedIcon = styled("div")(({ theme }) => ({
    ...
    return (
      <Root>
        <Container maxWidth="lg">
          ...
          >
            <div>
              <h2 style={{ color: titleBlue }}>Notifications</h2>
            </div>
          ...
          <Grid container spacing={3}>
            ...
            <Grid item lg={6} xs={12}>
              ...
              <TextField
                ...
                helperText={
                  this.state.isValidSubject ? "" : "Subject cannot be empty."
                }
                fullWidth
                margin="normal"
              ...
              <TextField
                ...
                helperText={
                  this.state.isValidMessage ? "" : "Message cannot be empty."
                }
